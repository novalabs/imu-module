...
/*
 * Setup for CORE IMU module board.
 */

/*
 * Board identifier.
 */
#define BOARD_CORE_IMU_module
#define BOARD_NAME                  "CORE IMU module"
...
#define GPIOA_PIN0                  0
#define GPIOA_PIN1                  1
#define GPIOA_AM_INT1               2
#define GPIOA_AM_INT2               3
#define GPIOA_AM_CS                 4
...
#define GPIOB_GYRO_INT1             0
#define GPIOB_GYRO_INT2             1
#define GPIOB_GYRO_CS               2
 ...
 * PA1  - AM_INT1                   (input pullup).
 * PA2  - AM_INT2                   (input pullup).
 * PA3  - PIN3                      (input pullup).
 * PA4  - AM_CS                     (output pushpull maximum).
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_PIN0) |           \
                                     ...
                                     PIN_MODE_INPUT(GPIOA_AM_INT1) |        \
                                     PIN_MODE_INPUT(GPIOA_AM_INT2) |        \
                                     PIN_MODE_OUTPUT(GPIOA_AM_CS) |         \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_AM_INT1) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOA_AM_INT2) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOA_AM_CS) |      \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_2M(GPIOA_PIN0) |            \
                                     ...
                                     PIN_OSPEED_100M(GPIOA_AM_INT1) |       \
                                     PIN_OSPEED_100M(GPIOA_AM_INT2) |       \
                                     PIN_OSPEED_100M(GPIOA_AM_CS) |         \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLUP(GPIOA_PIN0) |         \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOA_AM_INT1) |      \
                                     PIN_PUPDR_PULLUP(GPIOA_AM_INT2) |      \
                                     PIN_PUPDR_PULLUP(GPIOA_AM_CS) |        \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOA_AM_INT1) |          \
                                     PIN_ODR_HIGH(GPIOA_AM_INT2) |          \
                                     PIN_ODR_HIGH(GPIOA_AM_CS) |            \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_PIN0, 0) |           \
                                     ...
                                     PIN_AFIO_AF(GPIOA_AM_INT1, 0) |        \
                                     PIN_AFIO_AF(GPIOA_AM_INT2, 0) |        \
                                     PIN_AFIO_AF(GPIOA_AM_CS, 0) |          \
 ...
 * GPIOB setup:
 *
 * PB0  - GYRO_INT1                 (input pullup).
 * PB1  - GYRO_INT2                 (input pullup).
 * PB2  - GYRO_CS                   (output pushpull maximum).
 ...
 */
#define VAL_GPIOB_MODER             (PIN_MODE_INPUT(GPIOB_GYRO_INT1) |      \
                                     PIN_MODE_INPUT(GPIOB_GYRO_INT2) |      \
                                     PIN_MODE_OUTPUT(GPIOB_GYRO_CS) |       \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_GYRO_INT1) |  \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_GYRO_CS) |    \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_100M(GPIOB_GYRO_INT1) |     \
                                     PIN_OSPEED_100M(GPIOB_GYRO_INT2) |     \
                                     PIN_OSPEED_100M(GPIOB_GYRO_CS) |       \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_GYRO_INT1) |    \
                                     PIN_PUPDR_PULLUP(GPIOB_GYRO_INT2) |    \
                                     PIN_PUPDR_FLOATING(GPIOB_GYRO_CS) |    \
...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_GYRO_INT1, 0) |      \
                                     PIN_AFIO_AF(GPIOB_GYRO_INT2, 0) |      \
                                     PIN_AFIO_AF(GPIOB_GYRO_CS, 0) |        \
...
#define VAL_GPIOD_OSPEEDR           (PIN_OSPEED_100M(GPIOD_OSC_IN) |        \
